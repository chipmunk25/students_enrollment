...
const studentSchema = [
    ...
    body('dateOfBirth').exists().notEmpty().withMessage('Date of Birth is Required').isDate().isISO8601({ strict: true, strictSeparator: true }).withMessage('Invalid Date of Birth').custom((value) => {
        // Check if the value is a valid date in ISO-8601 format
